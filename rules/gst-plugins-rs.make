...
GST_PLUGINS_RS_ENABLEC-$(PTXCONF_GST_PLUGINS_RS_ANALYTICS)		+= analytics
GST_PLUGINS_RS_ENABLEP-$(PTXCONF_GST_PLUGINS_RS_ANALYTICS)		+= rsanalytics
...
GST_PLUGINS_RS_ENABLEC-$(PTXCONF_GST_PLUGINS_RS_AUDIOPARSERS)		+= audioparsers
GST_PLUGINS_RS_ENABLEP-$(PTXCONF_GST_PLUGINS_RS_AUDIOPARSERS)		+= rsaudioparsers
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_AWS)			+= aws
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_BURN)			+= burn
...
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_DEEPGRAM)		+= deepgram
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_DEMUCS)			+= demucs
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_ELEVENLABS)		+= elevenlabs
...
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_MPEGTSLIVE)		+= mpegtslive
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_NDI)			+= ndi
GST_PLUGINS_RS_ENABLEC-$(PTXCONF_GST_PLUGINS_RS_ORIGINALBUFFER)		+= originalbuffer
...
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_QUINN)			+= quinn
...
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_SKIA)			+= skia
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_SODIUM)			+= sodium
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_SPEECHMATICS)		+= speechmatics
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_SPOTIFY)			+= spotify
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_STREAMGROUPER)		+= streamgrouper
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_TEXTACCUMULATE)		+= textaccumulate
...
GST_PLUGINS_RS_ENABLEC-$(PTXCONF_GST_PLUGINS_RS_VALIDATE)		+= validate
...
GST_PLUGINS_RS_ENABLE-$(PTXCONF_GST_PLUGINS_RS_VVDEC)			+= vvdec
...
ifdef PTXCONF_GST_PLUGINS_RS_VALIDATE
	@$(call install_copy, gst-plugins-rs, 0, 0, 0644, -, \
		/usr/lib/gstreamer-1.0/validate/libgstrsvalidate.so)
endif
